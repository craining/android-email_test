...
package com.example.k9testtest.smtp_androidmail;
...
import com.example.k9testtest.smtp_androidmail.Message.RecipientType;
...
public class SmtpSender extends Sender {
    ...
    String mUsername = "devmail35@163.com";
    String mPassword = "QWERTYUIOP";
        ...
        try {
            ...
            try {
                ...
                localHost = localAddress.getHostName();
                    ...
                    Log.d("SmtpSender", "Unable to look up localhost");
            }
            ...
            if (mTransport.canTryTlsSecurity()) {
                if (result.contains("-STARTTLS")) {
                    ...
                    result = executeSimpleCommand("EHLO " + localHost);
                        ...
                        Log.d("SmtpSender", "TLS not supported but required");
            ...
            if (mUsername != null && mUsername.length() > 0 && mPassword != null
                ...
                if (authPlainSupported) {
                    ...
                    saslAuthLogin(mUsername, mPassword);
                        ...
                        Log.d("SmtpSender", "No valid authentication mechanism found.");
                    throw new MessagingException(MessagingException.AUTH_REQUIRED);
                }
            }
        } catch (SSLException e) {
                Log.d("SmtpSender", e.toString());
            throw new CertificateValidationException(e.getMessage(), e);
        } catch (IOException ioe) {
                Log.d("SmtpSender", ioe.toString());
...
//    S: 235 2.0.0 OK Authenticated
    ...
    private void saslAuthLogin(String username, String password) throws MessagingException,
        ...
        try {
            ...
            executeSensitiveCommand(new String(Base64.encode(username.getBytes(), Base64.DEFAULT)), 
                    "/username redacted/");
            executeSensitiveCommand(new String(Base64.encode(password.getBytes(), Base64.DEFAULT)), 
                    "/password redacted/");
        }
